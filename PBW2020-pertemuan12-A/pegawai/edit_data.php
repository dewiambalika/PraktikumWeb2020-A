                ...
                <form method="POST" action="">
                    <table class="tabel" style="width:50%">
                        ...
                        <td><input type="hidden" name="id" value=<?php echo $_GET['id'];?>></td>
                            <td><br><input type="submit" name="update" value="UPDATE"  style='background-color: #0080e0; border-radius: 1rem; cursor: pointer; color: white; padding: 8px 20px;'></td>
                        </tr>		
                    </table>
                </form>
